...
位置描述不含具体路名和英文类型。机动车道路（含高速、干线、主要/次要公路及居民区道路等）统一写“位于公路边”；track 及 track_grade1–5 写“位于农林道路边”；footway/path/steps/pedestrian 写“位于步行道路边”。自行车道、马道、在建及规划道路单独表述，未知类型写“类别未明确的道路”。描述后保留最近距离。这里是位置描述归并，不代表法定公路等级认定；为保持输出兼容，“位置类型”仍按原大类公路/铁路/村庄，详细 OSM 类型保留在“地物子类”。铁路、村庄分别写“位于铁路边”“位于村庄周边”。
